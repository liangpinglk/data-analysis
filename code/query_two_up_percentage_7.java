...
public class query_two_up_percentage_7 {
	/*
	 * 
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		System.out.println("query_two_up_percentage_7 begin");
		Configuration conf = new Configuration();
		conf.set("fs.defaultFS", "hdfs://192.168.23.9:9000");
		// 1.实例化一个Job
		Job job = Job.getInstance(conf, "query_two_up_percentage_7");
		// 2.设置mapper类
		...
		// 设置通过哪个类查找job的Jar包
		job.setJarByClass(query_two_up_percentage_7.class);
		// 7.设置输入路径
		...
		System.out.println("查询次数大于2次的用户占比为：" + percentage);
